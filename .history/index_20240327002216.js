...
app.post("/geo_vector", async (req, res) => {
  ...
  try {
    ...
    const existingVector = await sequelize.query(
      "SELECT * FROM geo_map_vector WHERE vector_id = $1 AND vector_type_id = $2",
      {
    ...
    await sequelize.query(
      "INSERT INTO geo_map_vector (geom, vector_id, layer_id, layer_name,source, source_id, vector_type_id, map_id, is_active) VALUES ($1, $2, $3, $4, $5, $6, $7, $8)",
      {
        bind: [
          geom,
          vector_id,
